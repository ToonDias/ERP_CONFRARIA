...
urlpatterns = [
    ...
    path('detail/pj/<int:pk>',views.PessoaJuridicaDetailView.as_view(), name='pssoa_juridica_detail'),
    # delete views
    path('delete/pf/<int:pk>',views.PessoaFisicaDeleteView.as_view(), name='pessoa_fisica_delete'),
    path('delete/pj/<int:pk>',views.PessoaJuridicaDeleteView.as_view(), name='pssoa_juridica_delete'),
    # search views
