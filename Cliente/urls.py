...
urlpatterns = [
    ...
    path('create/J',views.PessoaJuridicaCreateView.as_view(), name='pessoa_juridica_create'),
    # update views
    path('update/F/<int:pk>',views.PessoaFisicaUpdateView.as_view(), name='pessoa_fisica_update'),
    path('update/J/<int:pk>',views.PessoaJuridicaUpdateView.as_view(), name='pessoa_juridica_update'),
    # details views
